...
// import com.asialocalguide.gateway.core.domain.SixHourTimeSlot;
...
//  @Test
//  void testMapToActivityData_NullDates() {
//    AvailabilityResult result =
//        ViatorActivityAvailabilityMapper.mapToActivityData(
//            List.of(mockViatorActivityAvailabilityDTO()), null, null, SixHourTimeSlot.class);
//
//    assertThat(result.availability()).isEmpty();
//    assertThat(result.startTimes()).isEmpty();
//  }
...
//  @Test
//  void testMapToActivityData_ValidSingleActivity() {
...
//  @Test
//  void testMapToActivityData_UnavailableDate() {
//    LocalDate minDate = LocalDate.of(2025, 1, 1);
//    LocalDate maxDate = LocalDate.of(2025, 1, 5);
//
//    AvailabilityResult result =
...
//    AvailabilityResult result =
//        ViatorActivityAvailabilityMapper.mapToActivityData(
//            List.of(mockViatorActivityAvailabilityDTOWithMultipleTimes()),
//            minDate,
//            maxDate,
//            SixHourTimeSlot.class);
//
...
//  @Test
//  void testMapToActivityData_NoEndDate() {
//    LocalDate minDate = LocalDate.of(2025, 1, 1);
//    LocalDate maxDate = LocalDate.of(2025, 1, 5);
//
//    AvailabilityResult result =
//        ViatorActivityAvailabilityMapper.mapToActivityData(
//            List.of(mockViatorActivityAvailabilityDTOWithoutEndDate()),
//            minDate,
//            maxDate,
//            SixHourTimeSlot.class);
//
